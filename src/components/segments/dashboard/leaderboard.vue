    ...
    <div class="flex flex-col items-center text-center w-full max-w-5xl mx-auto">
      ...
      <div v-if="viewMode === 'global'" >
        <div>
          ...
          <div class="mx-auto px-5 py-4 rounded-xl border-4 border-yellow-700 mt-5 bg-gradient-to-b from-yellow-50 to-amber-100 shadow-md w-sm text-center">
            <button class="text-sm font-bold  tracking-wider text-yellow-900 mr-2" @click="seeMyPosition">Get my page</button>
          </div>
        </div>
