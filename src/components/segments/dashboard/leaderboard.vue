  ...
  <section class="snap-start w-full px-4 mt-6 lg:mt-12">
    <div class="flex flex-col items-center text-center w-full max-w-5xl mx-auto">
      ...
      <div v-if="viewMode === 'global'">
        <div>
          <button class="cursor-pointer text-sm font-bold tracking-wider text-yellow-900 mr-2 mx-auto px-2 py-2 rounded-xl border-4 border-yellow-700 mt-5 bg-gradient-to-b from-yellow-50 to-amber-100 shadow-md w-sm text-center" @click="seeMyPosition">
              Get my page
          </button>
        </div>
